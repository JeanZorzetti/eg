...
export default function Footer() {
  return (
    <footer className="bg-[#062e24] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="text-lg font-bold text-white">EG Telemedicina</span>
            </Link>
            <p className="text-sm text-green-200/70 leading-relaxed max-w-xs">
              Saúde de qualidade onde você estiver. Conectando pacientes a especialistas com tecnologia e humanidade.
            </p>
            {/* Social Links */}
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-green-200/50">
            © 2025 EG Telemedicina. Todos os direitos reservados.
          </p>
          <p className="text-xs text-green-200/40">
            Regulamentado pelo CFM — Conselho Federal de Medicina
          </p>
        </div>
      </div>
    </footer>
