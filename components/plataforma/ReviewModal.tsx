  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#26215C] to-[#7F77DD] p-5 text-white">
        ...
        <div className="p-6 space-y-5">
          {submitted ? (
            <div className="text-center py-4 space-y-3">
              ...
              <p className="text-base font-semibold text-[#26215C]">Avaliação enviada!</p>
              ...
              <button
                onClick={onClose}
                className="mt-2 inline-flex items-center justify-center rounded-xl bg-[#7F77DD] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#26215C] transition-colors"
              >
                Fechar
              </button>
            </div>
            ...
            <>
              <div>
                <p className="text-sm font-medium text-[#26215C] mb-3">Como foi sua consulta?</p>
              ...
              <div>
                <label className="block text-sm font-medium text-[#26215C] mb-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  maxLength={500}
                  className="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-[#7F77DD] focus:outline-none focus:ring-1 focus:ring-[#7F77DD] resize-none"
                />
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex-1 rounded-xl bg-[#7F77DD] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#26215C] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
