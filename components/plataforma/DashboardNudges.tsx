...
function Nudge({
  ...
  const variantClass = {
    info: 'bg-[#EEEDFE] border-[#CECBF6] text-[#26215C]',
        ...
        <Nudge id="first-appointment" variant="info">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <Link
              ...
              className="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-[#7F77DD] text-white px-4 py-2 text-xs font-semibold hover:bg-[#26215C] transition-colors"
            >
              Agendar agora →
            </Link>
          </div>
