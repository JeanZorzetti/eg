        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="border-t border-gray-100 pt-4">
              <p className="text-sm font-semibold text-[#26215C] mb-3">Avaliacao</p>
              ...
              {appointment.review ? (
                ...
                <div className="bg-[#EEEDFE] rounded-xl p-4 text-center">
                  <p className="text-xs text-gray-600 mb-3">
                    Voce ainda nao avaliou esta consulta. Seu feedback ajuda outros pacientes!
                  </p>
                  <button
                    onClick={() => setShowReview(true)}
                    className="inline-flex items-center gap-2 rounded-xl bg-[#7F77DD] px-4 py-2 text-xs font-semibold text-white hover:bg-[#26215C] transition-colors"
                  >
                    Avaliar consulta
                  </button>
                </div>
