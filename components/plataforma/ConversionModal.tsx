      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="flex flex-col gap-2 pt-2">
            <Link
              href="/planos"
              className="flex items-center justify-center gap-2 rounded-xl bg-[#7F77DD] px-5 py-3 text-sm font-semibold text-white hover:bg-[#26215C] transition-colors"
            >
              Conhecer planos →
            </Link>
            <a
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-[#26215C] truncate">{name}</p>
