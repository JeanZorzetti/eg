...
function Initials({ name }: { name: string }) {
  ...
  return (
    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#7F77DD] to-[#26215C] flex items-center justify-center text-white font-bold text-base shrink-0">
      {initials}
    </div>
  )
}
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col gap-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-2">
              <p className="text-sm font-semibold text-[#26215C] leading-tight">{doctor.name}</p>
              {doctor.available && (
            ...
            <p className="text-xs text-[#7F77DD] font-medium mt-0.5">{doctor.specialty}</p>
        ...
        {isSubscriber ? (
          <Link
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-[#7F77DD] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#26215C] transition-colors"
          >
            Agendar consulta
          </Link>
        ) : (
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-xl border border-[#7F77DD] px-4 py-2.5 text-sm font-medium text-[#7F77DD] hover:bg-[#EEEDFE] transition-colors"
          >
