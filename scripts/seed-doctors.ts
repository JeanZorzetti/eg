...
const doctors = [
  ...
  {
    name: 'Dr. Alexandre Moreira Senter',
    specialty: 'Clínica Geral',
    crm: 'CRM/PR 56814',
    state: 'PR',
    bio: 'Médico com registro ativo no CRM-PR. Atua em consultas de clínica geral, acompanhamento preventivo e cuidado integral ao paciente.',
    rating: 5.0,
    reviewCount: 0,
    available: true,
  },
  {
    name: 'Dr. Rodrigo Marques Bayma Santos',
    specialty: 'Clínica Geral',
    crm: 'CRM/PE 37408',
    state: 'PE',
    bio: 'Médico com registro ativo no CRM-PE. Atua em consultas de clínica geral, acompanhamento preventivo e cuidado integral ao paciente.',
    rating: 5.0,
    reviewCount: 0,
    available: true,
  },
  {
    name: 'Dra. Amanda Melo Fernandes',
    specialty: 'Clínica Geral',
    crm: 'CRM/PB 11424',
    state: 'PB',
    bio: 'Médica com registro ativo no CRM-PB. Atua em consultas de clínica geral, acompanhamento preventivo e cuidado integral ao paciente.',
    rating: 5.0,
    reviewCount: 0,
    available: true,
  },
  {
    name: 'Dra. Sâmera Hendges Heidemann',
    specialty: 'Clínica Geral',
    crm: 'CRM/PR 61642',
    state: 'PR',
    bio: 'Médica com registro ativo no CRM-PR. Atua em consultas de clínica geral, acompanhamento preventivo e cuidado integral ao paciente.',
    rating: 5.0,
    reviewCount: 0,
    available: true,
  },
