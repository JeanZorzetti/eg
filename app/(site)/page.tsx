...
const features = [
  {
    ...
    description: 'Seja atendido no conforto do seu lar com videoconsultas em HD e privacidade médica garantida.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Corpo clínico próprio com médicos experientes e certificados, rigorosamente selecionados.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Pronto atendimento disponível a qualquer hora. Saúde sem fronteiras de horário.',
  },
]
      ...
      <section className="relative bg-[#26215C] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 lg:pt-28 lg:pb-40">
          <div className="max-w-2xl">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md text-[#CECBF6] text-sm font-medium px-4 py-1.5 rounded-full mb-6 border border-white/15 shadow-lg shadow-black/10">
            ...
            <p className="text-base sm:text-lg text-[#B8B5CC] leading-relaxed mb-8 max-w-lg font-light">
              Consultas médicas online com especialistas qualificados. Rápido, seguro e acessível — do litoral ao sertão.
            </p>

            <div className="flex flex-wrap items-center gap-4 mb-10">
              <AgendarButton
                className="inline-flex items-center gap-2 bg-white text-[#26215C] hover:bg-[#EEEDFE] font-bold px-7 py-3.5 rounded-2xl transition-all duration-200 hover:shadow-2xl hover:shadow-[#7F77DD]/30 hover:-translate-y-0.5 text-base"
              >
              ...
              <Link
                href="/como-funciona"
                className="inline-flex items-center gap-2 border border-white/25 text-white hover:bg-white/10 font-medium px-7 py-3.5 rounded-2xl transition-all duration-200 backdrop-blur-sm text-base"
              >
                Como funciona
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 bg-white/8 backdrop-blur-md border border-white/12 rounded-full px-4 py-2 text-sm text-[#CECBF6]">
