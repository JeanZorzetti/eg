...
const stethoscopeIcon = (
  <svg className="w-5 h-5 text-[#029641]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">Especialidades para adultos</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {adultSpecialties.map((specialty) => (
              ...
              >
                ...
                <span className="text-sm font-medium text-[#062e24]">{specialty}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">Saúde infantil</h2>
          ...
          <div className="text-center">
            <Link
              href="/contato"
              className="inline-block bg-[#029641] hover:bg-[#016d2f] text-white font-semibold px-7 py-3 rounded-xl transition-all duration-200"
            >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">Terapias</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {therapies.map((therapy) => (
              ...
              >
                <div className="w-14 h-14 bg-[#029641] rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h3 className="text-lg font-bold text-[#062e24] mb-2">{therapy.title}</h3>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto bg-[#029641] rounded-2xl px-8 py-14 text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/contato"
              className="bg-white text-[#029641] hover:bg-green-50 font-bold px-7 py-3 rounded-xl transition-all duration-200"
            >
              Agendar consulta
            </Link>
            <a
