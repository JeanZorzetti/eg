        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {contactInfo.map((info) => (
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 bg-[#EEEDFE] text-[#7F77DD] rounded-xl flex items-center justify-center">
                  {info.icon}
                </div>
                <div>
                  <h3 className="font-bold text-[#26215C] mb-2">{info.title}</h3>
                  {info.lines.map((line) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Form */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-[#26215C] mb-2">
                Envie uma mensagem
              </h2>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      <span className="text-[#7F77DD] font-bold">{schedule.hours}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-[#EEEDFE] rounded-2xl p-6 border border-[#CECBF6]">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-bold text-[#26215C]">WhatsApp</h3>
                </div>
