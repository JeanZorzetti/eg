...
function NoSubscriptionGate() {
  return (
    <div className="max-w-2xl space-y-8">
      ...
      {/* Highlights */}
      <div className="bg-[#EEEDFE] rounded-2xl p-6 space-y-3">
        <p className="text-sm font-semibold text-[#26215C] mb-1">Com um plano EG você tem:</p>
        {[
          ...
          <div key={item} className="flex items-center gap-2 text-sm text-[#26215C]">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <div className="grid grid-cols-3 text-xs font-semibold text-center bg-gray-50 border-b border-gray-200">
          ...
          <div className="px-4 py-3 text-[#7F77DD]">EG Telemedicina</div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          href="/planos"
          className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#7F77DD] px-5 py-3 text-sm font-semibold text-white hover:bg-[#26215C] transition-colors"
        >
          Conhecer planos →
        </Link>
        <a
