...
function PreviewDashboard({ firstName }: { firstName: string }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl bg-[#EEEDFE] border border-[#CECBF6] px-5 py-3 text-sm">
        <span className="flex items-center gap-1.5 font-medium text-green-700">
          <span className="w-2 h-2 rounded-full bg-green-500 inline-block animate-pulse" />
          Atendimento ativo agora
        </span>
        <span className="text-[#CECBF6] hidden sm:inline">|</span>
        <span className="flex items-center gap-1 text-[#26215C] font-semibold">
        ...
        <span className="text-[#CECBF6] hidden sm:inline">|</span>
        <span className="text-[#26215C] font-semibold">Regulamentado pelo CFM</span>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-5">
            <div className="w-9 h-9 rounded-xl bg-[#EEEDFE] flex items-center justify-center mb-3">
              <svg className="w-5 h-5 text-[#7F77DD]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <p className="text-sm font-semibold text-[#26215C] mb-1">Recomendação Preventiva</p>
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 p-5 overflow-hidden">
            <div className="filter blur-[4px] select-none pointer-events-none">
              ...
              <p className="text-sm font-semibold text-[#26215C] mb-1">Fatores de Risco</p>
              <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 p-5 overflow-hidden">
            <div className="filter blur-[4px] select-none pointer-events-none">
              ...
              <p className="text-sm font-semibold text-[#26215C] mb-1">Recomendação Personalizada</p>
              <p className="text-xs text-gray-600 leading-relaxed">
        ...
        <p className="mt-3 text-xs text-gray-500">
          <a href="/planos" className="text-[#7F77DD] font-medium hover:underline">
