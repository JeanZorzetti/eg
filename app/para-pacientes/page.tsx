    ...
    <main className="min-h-screen">
      <section className="bg-[#062e24] py-20 text-white text-center">
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-4xl font-bold mb-4">Para Pacientes</h1>
          <p className="text-lg text-white/80">Acesse médicos qualificados de forma rápida, segura e acessível.</p>
        </div>
      </section>
