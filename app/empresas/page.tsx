...
const benefits = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#029641]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">Benefícios para sua empresa</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {benefits.map((benefit) => (
              ...
              >
                ...
                <h3 className="text-base font-bold text-[#062e24] mb-2">{benefit.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">Como funciona</h2>
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="relative text-center">
                ...
                <div className="relative">
                  <div className="w-16 h-16 bg-[#029641] text-white rounded-full flex items-center justify-center text-2xl font-extrabold mx-auto mb-5 shadow-lg shadow-[#029641]/25">
                    {step.number}
                  </div>
                  <h3 className="text-base font-bold text-[#062e24] mb-2">{step.title}</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">EG vs. plano tradicional</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            {/* EG Telemedicina */}
            <div className="bg-white border-2 border-[#029641] ring-2 ring-[#029641]/20 rounded-2xl p-8 shadow-lg">
              <div className="text-[#029641] font-bold text-lg mb-1">EG Telemedicina</div>
              <div className="text-2xl font-extrabold text-[#062e24] mb-3">Custo acessível</div>
              <p className="text-gray-500 text-sm leading-relaxed">
              ...
              <ul className="mt-5 space-y-2">
                {['Custo reduzido', 'Sem carência', 'Ativação imediata', 'Atendimento nacional'].map((item) => (
                  <li key={item} className="flex items-center gap-2 text-sm text-gray-700">
                    <svg className="w-4 h-4 text-[#029641] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#062e24] mb-3">O que dizem as empresas parceiras</h2>
            ...
            {testimonials.map((t) => (
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-3.5 h-3.5 text-[#029641]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-[#029641] text-white rounded-full flex items-center justify-center text-xs font-bold shrink-0">
                    {t.initials}
                  </div>
                  <div>
