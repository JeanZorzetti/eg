...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#062e24] via-[#074a38] to-[#029641] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-green-200 text-sm font-medium px-4 py-1.5 rounded-full mb-6 border border-white/20">
              <span className="w-2 h-2 bg-[#10b981] rounded-full animate-pulse" />
              Médicos disponíveis agora
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
              Saúde de qualidade{' '}
              <span className="text-[#10b981]">onde você estiver</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/contato"
                className="inline-flex items-center gap-2 bg-white text-[#029641] hover:bg-green-50 font-bold px-7 py-3.5 rounded-xl transition-all duration-200 hover:shadow-xl hover:-translate-y-0.5"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#062e24] mb-3">{feature.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#062e24] mb-4">Como Funciona</h2>
            <p className="text-gray-500 max-w-xl mx-auto">
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="relative text-center">
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-1/2 w-full h-0.5 bg-gradient-to-r from-[#029641] to-[#10b981] opacity-20" />
                )}
            ...
            {testimonials.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#029641] text-white rounded-full flex items-center justify-center text-sm font-bold">
                    {t.initials}
                  </div>
                  <div>
      ...
      {/* Final CTA */}
      <section className="py-20 bg-gradient-to-r from-[#029641] to-[#10b981]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <Link
            href="/contato"
            className="inline-flex items-center gap-2 bg-white text-[#029641] hover:bg-green-50 font-bold px-8 py-4 rounded-xl transition-all duration-200 hover:shadow-2xl hover:-translate-y-0.5 text-lg"
          >
            Comece Agora
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
